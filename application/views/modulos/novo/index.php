		...
		<div class="row">
			...
			<div class="statistics col-lg-3 col-12">
				<div class="statistic d-flex align-items-center bg-white has-shadow">
					...
					<div class="text"><strong>125</strong><br><small><button id="atend" class="btn btn-primary" type="button">Atendimentos Realizados</button></small></div>
				</div>
				<div class="statistic d-flex align-items-center bg-white has-shadow">
					<div class="icon bg-green"><i class="fa fa-calendar-o"></i></div>
					<div class="text"><strong>1</strong><br><small><button id="guiaatual" class="btn btn-primary" type="button">Guia Atualmente Utilizada</button></small></div>
				</div>
				<div class="statistic d-flex align-items-center bg-white has-shadow">
					<div class="icon bg-orange"><i class="fa fa-paper-plane-o"></i></div>
					<div class="text"><strong>16</strong><br><small><button id="guiainativa" class="btn btn-primary" type="button">Guias Cadastradas</button></small></div>
				</div>
				<div class="statistic d-flex align-items-center bg-white has-shadow">
					<div class="icon bg-orange"><i class="fa fa-paper-plane-o"></i></div>
					<div class="text"><strong>Outras</strong><br><small><a href="#">Informações Adicionais</a></small></div>
				</div>
			</div>
...
$(document).ready(function(){
    $('#atendimentos').load("<?php echo site_url(); ?>novo/atendimentos");
    $("#guiaatual").click(function( e ){
      
      $('#atendimentos').load("<?php echo site_url(); ?>novo/guias_abertas");
    });
    $("#guiainativa").click(function( e ){
      
      $('#atendimentos').load("<?php echo site_url(); ?>novo/guias_fechadas");
    });
