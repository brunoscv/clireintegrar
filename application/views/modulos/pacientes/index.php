											...
											<tbody>
												<?php foreach($listaPacientes as $item): ?>
													<tr>
														...
														<td><?php echo ($item->status_consulta == 1) ? '<span class="label label-success"> Ativos </span>' : '<span class="label label-danger"> Inativo </span>';?></td>
														<td class="td-actions">
															<button type="button" 
																	...
																	data-content="<a href='<?php echo site_url("pacientes/editar/".$item->id); ?>' class='ver_info'>
                                                                                    ...
                                                                                    <a href='<?php echo site_url("novo/index/".$item->id); ?>' class='editar_info'>
																					<p><i class='btn-icon-only fa fa-user'></i></span> Prototipo</p> "
